...
// The homepage "Life" teaser shows the first three — keep scenery (no face) first.
export const photos: Photo[] = [
  ...
  { src: '/photos/point-reyes.jpg', caption: 'Point Reyes Lighthouse', alt: 'The lighthouse at Point Reyes above the ocean' },
